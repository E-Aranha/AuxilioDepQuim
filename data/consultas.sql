...
SELECT A.NOME,
CASE 
    WHEN  ES.DURACAO_limite - current_date < 10 AND ES.DURACAO_limite - CURRENT_DATE > 0
        THEN 'PROXIMO AO FIM'
    WHEN ES.DURACAO_limite- current_date > 10 
        THEN 'FUNCIONARIO EMPREGADO'
    WHEN (ES.DURACAO_limite - current_date < 0) OR ES.DURACAO IS NULL
